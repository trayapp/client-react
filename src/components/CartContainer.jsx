...
const CartContainer = () => {
  ...
  return (
    <div className="no-select fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]">
      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
        ...
        <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-thin">
          ...
          <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2">
            <img
              src="//localhost:8000/media/images/items/pate.png"
            ...
            <div className="flex flex-col gap-2">
              <p className="text-base text-gray-50">Pate</p>
        ...
        <div className="w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
          <div className="w-full flex items-center justify-between">
            ...
            <p className="text-gray-400 text-lg">₦ 3,500</p>
          </div>
          <div className="w-full flex items-center justify-between">
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <p className="text-gray-200 text-xl font-semibold">₦ 3,700</p>
          </div>
          <motion.button
            whileTap={{ scale: 0.8 }}
            type="button"
